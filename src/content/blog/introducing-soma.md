...
Soma is source-available under the [meetsoma](https://github.com/meetsoma) GitHub organization. The protocol specs and ideas are open. The implementation is licensed under BSL 1.1, converting to MIT after eighteen months. [Get started](/docs/getting-started) — install it, extend it, or contribute.
