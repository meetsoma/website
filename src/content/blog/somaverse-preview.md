---
title: "Somaverse: Where AI Agents Live"
description: "A tiling workspace where your AI agent can see your screen, control browser tabs, and use your terminal. Not a chatbot with plugins — a co-pilot with eyes and hands."
...
<div style="text-align:center; margin:40px 0 48px;">
  <div style="font-family:'Manrope',system-ui,sans-serif; font-weight:800; font-size:clamp(36px,6vw,52px); color:#e4eaf4; letter-spacing:-0.5px; line-height:1;">S<span style="color:#f0c866;">σ</span>maverse</div>
  <div style="font-size:13px; color:#647080; margin-top:8px; letter-spacing:1px;">WHERE AI AGENTS LIVE</div>
</div>
...
<div style="background:rgba(11,16,24,0.85); border:1px solid rgba(132,148,170,0.12); border-radius:12px; padding:24px 28px; margin:32px 0; font-family:monospace; font-size:13px; line-height:2;">
  ...
  <div><span style="color:#7cb2d4;">files</span><span style="color:#647080;"> file:open </span><span style="color:#f0c866;">→</span><span style="color:#647080;"> file:load </span><span style="color:#7cb2d4;">editor</span></div>
</div>
...
<div style="text-align:center; margin:0 0 24px;">
  <div style="font-family:'Manrope',system-ui,sans-serif; font-weight:800; font-size:28px; color:#e4eaf4;">
    <span style="color:#f0c866;">σ</span> Genesis
  </div>
</div>
...
<div style="margin:0 0 16px;">
  <div style="font-family:'Manrope',system-ui,sans-serif; font-weight:800; font-size:24px; color:#e4eaf4;">
    S<span style="color:#f0c866;">σ</span>ma + S<span style="color:#f0c866;">σ</span>maverse
  </div>
</div>
